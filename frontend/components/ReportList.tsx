          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center text-sm text-slate-500 font-medium">
                <span className="w-6 h-6 rounded-md bg-slate-100 flex items-center justify-center mr-3 shadow-sm border border-slate-200/60 text-[10px] font-semibold text-slate-500">DATE</span>
