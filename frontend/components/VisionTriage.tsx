    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
            <div className="bg-blue-700 text-white p-4">
                ...
                <p className="text-blue-100 text-sm mt-1">{t.offline}</p>
            </div>

            <div className="p-5 md:p-8 space-y-8">
                {/* Voice Input Box */}
                <div className="bg-blue-50 rounded-2xl border-2 border-blue-200 p-6 flex flex-col items-center justify-center text-center">
                    ...
                    <button
                        ...
                        className={`w-20 h-20 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-105 ${isListening ? 'bg-red-500 animate-pulse' : 'bg-blue-600'}`}
                    >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-xl font-bold text-lg transition-colors shadow-sm"
                    >
                        <CameraIcon className="w-6 h-6" />
                        {t.takePhoto}
                    </button>
                        ...
                        <div className="p-6 md:p-8 flex flex-col items-center text-center">
                            ...
                            <div className="flex items-start gap-4 text-left w-full max-w-2xl mx-auto bg-slate-50 p-6 rounded-xl border border-slate-100">
                                <button
                                    ...
                                    className="p-3 bg-blue-100 text-blue-700 rounded-full hover:bg-blue-200 transition-colors flex-shrink-0"
                                    title="Play Audio"
                                >
